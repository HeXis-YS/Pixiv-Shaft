...
public class Params {
    ...
    public static final String FRAGMENT_SCROLL_TO_POSITION         = "ceui.lisa.FRAGMENT_SCROLL_TO_POSITION";
    ...
    public static final String URL_R18_SETTING  = "https://www.pixiv.net/settings/viewing";
